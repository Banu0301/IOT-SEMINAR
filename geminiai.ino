...
const char* ssid = "Infinix NOTE 30 5G";//SSID
const char* password = "6pecubnv6e4gi2i";//PASS
const char* Gemini_Token = "AIzaSyBq-vmwjm1qyFdSbYDfYAAbTX_aBlZ_nK0";   //GEMINI_API_KEY
